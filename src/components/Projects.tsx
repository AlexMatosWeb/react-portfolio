...
export default function Projects() {
  const projects = [
    {
      title: "Pokedex",
      description: "Projeto consumindo API pokeapi",
      image:
      ...
      link: "https://alexmatosweb.github.io/pokedex/pokedex/index.html",
      colSpan: "col-span-1",
    },
    {
      title: "Reserva de Hóteis",
      description: "Reserva de hótel com Bootstrap 5 ",
      image:
      ...
      link: "https://alexmatosweb.github.io/reservahotel/index.html",
      colSpan: "col-span-1 md:col-span-2",
    },
    {
      title: "Gerador de Senha ",
      description: "Projeto em JavaScript",
      image:
      ...
      link: "https://alexmatosweb.github.io/geradordesenha/",
      colSpan: "col-span-1",
    },
    {
      title: "X-Men",
    ...
    },
    {
      ...
      description: "Portal de notícias em WordPress",
      image:
